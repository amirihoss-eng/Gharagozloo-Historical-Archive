# Gholam Ali Gharagozloo

**Persian:** غلامعلی قراگوزلو  
**Permanent person ID:** `P0007`  
...
Brother of Gholamhossein Khan according to user-verified family tree.

## Names and aliases

- No alternate-name records currently stored.
...
- Child of **Mohtaj Ali Khan Gharagozloo** — *provisional*; Based on user-verified tree; exact published diagram reading still requires image-level confirmation.
- Sibling of **Gholamhossein Khan Amiri Gharagozloo** — *provisional*
...
- **Hajilu genealogy** (genealogy, book page 213) — Large genealogical chart including the Amir Nezam Letgahi line; fine-grained nodes require image-level review. [`A0015`]
