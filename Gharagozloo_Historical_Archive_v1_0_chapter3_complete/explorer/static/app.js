...
function route(name,arg){document.body.classList.toggle('graph-mode',name==='graphcore');if(name==='curator')return curator();if(name==='curatorpeople')return curatorPeople();if(name==='graphcore')return graphCore(arg);if(name==='home')return home();if(name==='people')return people(arg||'');if(name==='person')return person(arg);if(name==='timeline')return timeline();if(name==='gallery')return gallery();if(name==='estates')return estates();if(name==='estate')return estate(arg);if(name==='organizations')return organizations();if(name==='organization')return organization(arg);if(name==='titles')return titles();if(name==='title')return title(arg);if(name==='research')return research();}
